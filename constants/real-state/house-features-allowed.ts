export const INTERIOR_FEATURES_ALLOWED = ["water_tank", "water_cistern", "closets", "furnished", "air_conditioning", "garage", "allowPets", "parking"] as const
...
export const SECURITY_FEATURES_ALLOWED = ["gated_community", "24_7_security", "security_guard"] as const
